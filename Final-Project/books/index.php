                    ...
                    <div class="col-md-8">
                        <section class="panel">
                            ...
                            <div class="panel-body table-responsive">
                                ...
                                $tampil = pgsql_query($conn, $query1) or die(pgsql_error($conn));
                                ?>
                                <table class="table table-hover">
                                    ...
                                    <?php while ($data = pgsql_fetch_array($tampil)) { ?>
                                        <tbody>
                                            <tr>
                                ...
                                <hr />
                                <?php $tampil = pg_query($conn, "select * from pengunjung where tgl_kunjung='$tanggal'");
                                $user = pg_num_rows($tampil);
                                ?>
                                <center>
            ...
            <div class="col-md-12">
                <section class="panel">
                    ...
                    <div class="panel-body table-responsive">
                        ...
                        $tampil = pg_query($conn, $query) or die(pg_error($conn));
                        ?>
                        <table class="table table-hover">
                            <thead>
                                <tr>
                            ...
                            <?php while ($data1 = pg_fetch_array($tampil)) { ?>
                                <tbody>
                                    <tr>
                        ...
                        <hr />
                        <?php $tampil1 = pg_query($conn, "select * from admin order by id_admin");
                        $user1 = pg_num_rows($tampil1);
                        ?>
                        <center>
